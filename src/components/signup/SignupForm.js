        ...
        return (
            <form className="form form-horizontal" role="form" method="post" onSubmit={this.onFormSubmit}>
                ...
                <div className="form-group">
                    ...
                    <input type="text" ref="name" className="form-control" name="name" onChange={this.handleOnChange}
                           required="required"/>
                </div>
                <div className="form-group">
                    <label className="control-label">Password</label>
                    <input type="password" ref="password" className="form-control" name="password"
                           onChange={this.handleOnChange} required="required"/>
                </div>
                <div className="form-group">
                    <label className="control-label">Email address</label>
                    <input type="email" ref="email" className="form-control" name="email" onChange={this.handleOnChange}
                           required="required"/>
                </div>
                <div className="form-group">
                    <label className="control-label">Phone Number</label>
                    <input type="phone" ref="phone" className="form-control" name="phone" onChange={this.handleOnChange}
                           required="true"/>
                </div>
                <div className="form-group">
